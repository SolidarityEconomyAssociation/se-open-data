...
HERE
          comment: 'Added "jurisdiction" field, redefined "country_name" as "country_id',
          primary_key: [:id],
          fields: [
            {id: :id,
             header: 'Identifier',
...
HERE
            ...
            {id: :organisational_structure,
             ...
             comment: <<-HERE,
This was known as legal_form. The allowed values are taken from the
relevant ESSGLOBAL SKOS vocabulary.
HERE
            },
            {id: :primary_activity,
             header: 'Primary Activity',
            ...
            {id: :country_id,
             header: 'Country ID',
             desc: <<-HERE,
This indicates the country in which the main address is located.
...
should be an ISO-3166-1 two-letter country code, or one of the
ICA's region/super-region identifiers. Upper case where applicable.
HERE
             comment: 'There are ESSGLOBAL SKOS vocabs for the ISO and ICA identifiers',
            },
            {id: :homepage,
             header: 'Website',
             desc: '',
